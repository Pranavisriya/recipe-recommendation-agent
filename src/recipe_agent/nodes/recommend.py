...
def generate_recommendation(state: RecipeAgentState, *, llm) -> RecipeAgentState:
    ...
    if not recipes:
        return {
            "messages": [
                AIMessage(content="I couldn’t find a matching recipe. Want to relax constraints or add more ingredients?")
            ]
        }
